...
public abstract class Pagamento {
	...
	//public String Pagamento(String dataHoraPagamento, int nuemroPagamento, double valorPago) {
		//return getDataHoraPagamento() + getNumeroPagamento() + getValorPago(); 
	//}
	
	public abstract String imprimirCupomFscal();
